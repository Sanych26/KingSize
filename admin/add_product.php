<?php
    ...
    global $connection;
        ...
        {
            global $connection, $art, $name, $price, $mainPhotoUrl, $tags;
            $addProduct = "INSERT IGNORE INTO products (id, product_art, product_name, product_price, product_img, tags) VALUE (NULL, '$art', '$name', '$price', '$mainPhotoUrl', '$tags')";
