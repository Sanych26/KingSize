    ...
    <div class="content">
        <div class="top-cont">
            <div class="slogan">
                ...
                <p>Все починається, коли ти відкриваєш взуттєву коробку<br />Просто нажми та замов.</p>
            </div>
            <div class="sneaker">
                                     ...
                                     while ($product = $products->fetch_assoc()) {
                                        ...
                                        <div class="galery-element">
                                            ...
                                            <div class="more-btn-cont">
                                                <a href="product.php?product_id=<?=$product['id']?>"><button class="more-btn" type="submit" name="more_button" value="Більше">Більше</button></a>
                                            </div>
                                        </div>
                                    <?php  $a++;
                                    }
